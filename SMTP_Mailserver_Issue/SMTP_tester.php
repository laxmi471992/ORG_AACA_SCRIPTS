 ...
 *
 * Usage: php SMTP_tester.php [optional_email_address]
...
function writeLog($message) {
    $logFile = '/home/pipewayweb/log/SMTP_tester.txt';
...
if ($customEmail) {
    ...
    if (!filter_var($customEmail, FILTER_VALIDATE_EMAIL)) {
        ...
        echo "\nUsage: php SMTP_tester.php [email@example.com]\n";
        exit(1);
    }
...
try {
    ...
    if ($customEmail) {
        ...
        $mail->addAddress('cdagan@aacanet.org');
    ...
    // Set email content
    $mail->isHTML(true);
    $mail->Subject = 'Test Email - PIPEWAY System';
    ...
    <body>
        <div class='container'>
            ...
            <div class='content'>
                <p>This is a test email from the <strong>PIPEWAY System</strong> to verify SMTP configuration and email delivery.</p>
            ...
            <div class='footer'>
                <p>American Alliance Creditors Association (AACA)<br>
    ...
    $mail->AltBody = "Test Email - PIPEWAY System\n\n"
                   . "This is a test email from the PIPEWAY System.\n\n"
                   . "Server: {$serverName}\n"
    ...
    if ($mail->send()) {
        ...
        echo "Log file: /home/pipewayweb/log/SMTP_tester.txt\n\n";
